...
var ScrollView = (function (_super) {
    ...
    ScrollView.prototype.reset = function (a_tag) {
        this.curItemCount = 0;
        if (this.isHScroller) {
    ...
    ScrollView.prototype.onChangeEndHandler = function () {
        // console.log("ItemScroller >> " + "change end" + this.itemNum);
        ...
        for (var i = 0; i < this.m_tag.length; i++) {
            this.m_tag[i].source = "actorList3_png";
        }
        this.m_tag[this.curItemCount].source = "actorList4_png";
    };
    /**滑动到下一项*/
    ...
    Object.defineProperty(ScrollView.prototype, "itemCount", {
        get: function () {
            return this.itemNum;
        },
        set: function (value) {
